.PHONY: help dev dev-backend dev-frontend db db-stop db-clean build test test-verbose test-stress test-stress-full lint clean docker-up docker-down sync-champions dc-build dc-up dc-down dc-shell dc-setup dc-logs dc-clean
